...
public class Countdown extends BaseActivity {
    ...
    public void SetBoutton(View view){
    ...
    private void updateWatchInterface() {
        if (mTimerRunning) {
            ...
            mButtonStartPause.setImageResource(R.drawable.ic_stat_pause);
        } else {
            mEditTextInput.setVisibility(View.VISIBLE);
            mButtonSet.setVisibility(View.VISIBLE);
            mButtonStartPause.setImageResource(R.drawable.ic_stat_start);
